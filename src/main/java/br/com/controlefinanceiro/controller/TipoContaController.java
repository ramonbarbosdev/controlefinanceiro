...
@RestController 
@RequestMapping(value = "/tipoconta", produces = "application/json")
public class TipoContaController extends BaseController<Tipo_Conta, Tipo_CategoriaDTO, Long>
{
	
	@Autowired
	private TipoContaRepository objetoRepository;

	public TipoContaController(CrudRepository<Tipo_Conta, Long> repository)
	{
		super(repository);
	}
