...
import br.com.controlefinanceiro.repository.StatusContaRepository;
...
@RestController 
@RequestMapping(value = "/statusconta", produces = "application/json")
public class StatusContaController extends BaseController<Status_Conta, Tipo_CategoriaDTO, Long>
{
	
	@Autowired
	private StatusContaRepository objetoRepository;

	public StatusContaController(CrudRepository<Status_Conta, Long> repository)
	{
		super(repository);
	}
